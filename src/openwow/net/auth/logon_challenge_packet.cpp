...
// The realm server accepts the TurtleWoW realm-list build family. World auth
// uses the separate classic build value in world_protocol.cpp.
constexpr std::uint8_t kMajorVersion = 1;
constexpr std::uint8_t kMinorVersion = 18;
constexpr std::uint8_t kBugfixVersion = 1;
constexpr std::uint16_t kBuildNumber = 7272;
