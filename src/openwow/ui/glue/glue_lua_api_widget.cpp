...
void EnsureWidgetMethodTable(lua_State* state) {
  ...
  static const MethodEntry kMethods[] = {
    ...
    {"UpdateScrollChildRect", LuaWidget_UpdateScrollChildRect},
...
int LuaWidget_UpdateScrollChildRect(lua_State *) {
  // Glue layout is solved from the XML/runtime widget tree on the next
  // traversal; the Classic method is otherwise intentionally side-effect
  // free for this runtime.
  return 0;
}
