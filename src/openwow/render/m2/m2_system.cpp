...
M2CameraSampleQuery M2System::QueryInstanceCameraSampleByLookup(std::uint32_t id, int lookup) const { return state_->spatial_queries.QueryCameraSample(id, lookup, M2CameraLookupKind::kLookupIndex); }
