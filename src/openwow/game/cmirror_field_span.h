...
inline constexpr std::uint32_t kUnitCompactSlotEnd = 182;
...
inline constexpr std::uint32_t kItemFieldCount   = 48;
inline constexpr std::uint32_t kUnitFieldCount   = 188;
