...
// Turtle/MaNGOS 1.12 ships the Classic VideoHardware.dbc layout: 22 uint32
// columns and 88 bytes per record. The WotLK-derived client previously
// hard-failed here while trying to read the 23-column layout.
constexpr std::uint32_t kVideoHardwareExpectedFieldCount = 22;
constexpr std::uint32_t kVideoHardwareExpectedRecordSize = 88;
